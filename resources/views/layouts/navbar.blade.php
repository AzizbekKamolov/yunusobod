            ...
            <div class="navbar-brand">
                <ul class="list-inline">
                    ...
                    <li class="list-inline-item"><a class="hidden-md hidden-lg" href="javascript:void(0)"
                                                    id="sidebar-toggle-button"><i class="ion-navicon tx-20"></i></a>
                    </li>
                    <!-- PC Toggle and Logo -->
                    <li class="list-inline-item"><a class="text-muted hidden-xs hidden-sm" href="javascript:void(0)"
                                                    id="collapsed-sidebar-toggle-button"><i
                                class="ion-navicon tx-20"></i></a></li>
                    <li class="list-inline-item mg-l-10"><a class="text-muted" href="javascript:void(0)"
                                                            id="search-button"><i
        ...
        <div class="header-right pull-right">
            <ul class="list-inline justify-content-end">
                ...
                <li class="list-inline-item dropdown hidden-xs hidden-sm">
                    <a class="text-muted" href="javascript:void(0)" role="button" data-toggle="dropdown"
                       aria-haspopup="true" aria-expanded="false">
                        <img src="{{  asset('assets/images/flags/'.app()->getLocale().'.png') }}"
                             class="mg-b-5 wd-20 img-fluid" alt="">
                    </a>
                    <ul class="dropdown-menu languages-dropdown shadow-2">
                        @foreach(config('app.languages') as $lang)
                            <li>
                                <a href="{{ route('dashboard.changeLang',$lang) }}" data-lang="en"><img
                                        src="{{ asset('assets/images/flags/'.$lang.'.png') }}" class="img-fluid wd-20"
                                        alt=""> <span>{{ $lang }}</span></a>
                            </li>
                        @endforeach
                    </ul>
                </li>
                ...
                <li class="list-inline-item dropdown">
                    <a class="text-muted" href="javascript:void(0)" role="button" data-toggle="dropdown"
                       aria-haspopup="true" aria-expanded="false">
                        <span class="select-profile">{{ auth()->user()->username }}!</span>
                    ...
                    <ul class="dropdown-menu profile-dropdown shadow-2">
                        <li>
                            <a href="{{ route('user.profile') }}"><i
                                    class="icon-user"></i><span>{{ __('form.my_profile') }}</span></a>
                        </li>
                        {{--                        <li>--}}
                        ...
                        <li>
                            <a href="{{ route('auth.logout') }}"><i
                                    class="icon-logout"></i><span>{{ __('auth.logOut') }}</span></a>
                        </li>
                    </ul>
                </li>
