<section
    class="elementor-section elementor-top-section elementor-element elementor-element-9b1a55f elementor-section-full_width elementor-section-stretched hero-area elementor-section-height-default elementor-section-height-default"
    data-id="9b1a55f" data-element_type="section"
    data-settings="{&quot;stretch_section&quot;:&quot;section-stretched&quot;}"
    style="width: 1281px; left: 0px;">
    <div class="elementor-container elementor-column-gap-default">
        <div
            class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-863b5a1"
            data-id="863b5a1" data-element_type="column">
            <div class="elementor-widget-wrap elementor-element-populated">
                <div
                    class="elementor-element elementor-element-e17eb70 elementor-widget elementor-widget-bizmax-hero-slider"
                    data-id="e17eb70" data-element_type="widget"
                    data-widget_type="bizmax-hero-slider.default">
                    <div class="elementor-widget-container">
                        ...
                        <section class="cs_hero_1-wrap position-relative cs_hero_slider bg-primary">
                            ...
                            <div class="cs_swiper_parallax_slider_wrap">
                                ...
                                <div
                                    class="cs_parallax_slider--272731362 swiper-initialized swiper-horizontal swiper-pointer-events swiper-watch-progress swiper-backface-hidden">
                                    ...
                                    <div class="swiper-wrapper"
                                        ...
                                        @foreach($sliders as $slider)
                                            ...
                                            <div
                                                ...
                                                role="group"
                                                aria-label="{{ $loop->iteration }} / {{ count($sliders) }}"
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            aria-controls="swiper-wrapper-d320b24bfa01489e">
                                    ...
                                    <div
                                        class="cs_hero_shape_1 position-absolute bottom-0 d-flex align-items-end h-100 cs_zindex_1">

                                        <svg width="434" height="759"
                                             viewBox="0 0 434 759"
                                             fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <path
                                                ...
                                                fill="url(#paint0_linear_81_287)"></path>
                                    ...
                                    <div
                                        class="cs_hero_shape_2 position-absolute start-0 cs_zindex_1">

                                        <svg width="572" height="572"
                                             viewBox="0 0 572 572"
                                             fill="none"
                                             xmlns="http://www.w3.org/2000/svg">

                                            <path
                                                d="M572 -6.10352e-05L6.10352e-05 572L1.10293e-05 -1.10293e-05L572 -6.10352e-05Z"
                                            ...
                                            <defs>
                                                ...
                                                <lineargradient
                                                    ...
                                                    x1="388.254" y1="307.69"
                                                    x2="-127.973"
                                                    y2="-227.83"
                                                    gradientUnits="userSpaceOnUse">

                                                    <stop offset="0.0457759"
                                                          stop-color="#18191D"
                                                          stop-opacity="0"></stop>

                                                    <stop offset="0.514455"
                                                          stop-color="#FEC63F"
