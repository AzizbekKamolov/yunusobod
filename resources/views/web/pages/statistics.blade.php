@section('head')
    <title>{{ __('web.menus.statistics') }}-{{ env('APP_NAME') }}</title>
@endsection
            ...
            <div class="container position-relative z-index-1">
                <nav aria-label="breadcrumb" class="breadcrumb-nav cs_fs_18 cs_mb_5">
                    ...
                    <span property="itemListElement" typeof="ListItem"><span property="name"
                                                                             class="post post-page current-item">{{ __('web.menus.statistics') }}</span><meta
                            property="url" content="{{ route('contact') }}"><meta property="position"
                                                                                                   content="2"></span>
                </nav>
                <h1 class="cs_fs_48 cs_fs_lg_36 text-white m-0">{{ __('web.menus.statistics') }}</h1>
            </div>
...
{{--                                                            style="color:#18191d">{{ __('web.partners.title') }}</h3>--}}
                                                        ...
                                                        <h2 class="section-title-heading  cs_fs_48 cs_fs_lg_36 cs_mb_20"
                                                            style="color:#18191d">{!!  __('web.statistics.title') !!}</h2>
                                            ...
                                            <div class="elementor-widget-container">
                                                <div class="bizmax-teams">
                                                    <div class="bizmax-clients__grid bizmax-team__grid">
                                                        <div class="row">
                                                            @foreach(trans('web.statistics.statistics') as $statistic)
                                                                <div class="col-lg-4 col-md-6 col-sm-6">

                                                                    <div
                                                                        class="cs_team cs_style_1 text-center cs_mt_30 overflow-hidden cs_rounded_50">

{{--                                                                        <div class="cs_team_member position-relativecs_rounded_50">--}}
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <a class="cs_team_link"
                                                                               href="#">
                                                                                ...
                                                                                <h2 class="text-white m-0  cs_mb_3">
                                                                                    {{ $statistic['amount'] }}</h2>

                                                                                <p class="text-white m-0">{{ $statistic['description'] }}</p>
                                                                            </a>
