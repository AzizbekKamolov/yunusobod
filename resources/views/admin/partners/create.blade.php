    ...
    <div class="row justify-content-center">
        <div class="col-md-12 col-lg-12">
            <div class="card mb-4 shadow-1">
                ...
                <div class="card-body">
                    <form class="needs-validation" action="{{ route("partners.store") }}" method="post" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="tab-pane fade" id="navs-top-home-bgcolor">
                                    <div class="form-row mt-3">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea type="text" class="form-control" id="about[uz]" name="about[uz]" ></textarea>
                                ...
                                <div class="tab-pane fade active show" id="navs-top-profile-bgcolor">
                                    <div class="form-row mt-3">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea class="form-control" id="about[ru]" name="about[ru]" ></textarea>
                                ...
                                <div class="tab-pane fade" id="navs-top-messages-bgcolor">
                                    <div class="form-row mt-3">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea class="form-control" id="about[en]" name="about[en]" ></textarea>
