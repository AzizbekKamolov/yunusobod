    ...
    <div class="row justify-content-center">
        <div class="col-md-12 col-lg-12">
            <div class="card mb-4 shadow-1">
                ...
                <div class="card-body">
                    <form class="needs-validation" action="{{ route("employees.store") }}" method="post"
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade" id="navs-top-home-bgcolor">
                                    <div class="col-md-12 mb-3 mt-3">
                                        ...
                                        <textarea name="about[uz]" id="about[uz]" class="form-control"></textarea>
                                ...
                                <div class="tab-pane fade active show" id="navs-top-profile-bgcolor">
                                    <div class="col-md-12 mb-3 mt-3">
                                        ...
                                        <textarea name="about[ru]" id="about[ru]" class="form-control"></textarea>
                                ...
                                <div class="tab-pane fade" id="navs-top-messages-bgcolor">
                                    <div class="col-md-12 mb-3 mt-3">
                                        ...
                                        <textarea name="about[en]" id="about[en]" class="form-control"></textarea>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <select name="direction_id" id="direction_id" class="form-control">
                                    @foreach($directions as $direction)
                                        <option value="{{ $direction->id }}">{{ $direction->titleH }}</option>
                                    @endforeach
                                </select>
