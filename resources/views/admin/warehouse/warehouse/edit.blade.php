                    ...
                    <form action="{{ route('warehouse.update',[$item->id])}}" method="post"
                        ...
                        <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="form-group justify-content-lg-start">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="name[uz]" class="form-control"
                                               id="name[uz]" value="{{ old('name.uz',$item->name_uz) }}"
                                ...
                                <div class="form-group justify-content-lg-start">
                                    ...
                                    <div class="col-md-12">
                                        <textarea rows="3" type="text" name="description_uz" class="form-control"
                                                  id="description_uz"
                                        >{{ old('description_uz',$item?->description_uz) }}</textarea>
                            ...
                            <div class="tab-pane fade active show" id="my-contact" role="tabpanel"
                                ...
                                <div class="form-group justify-content-end">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="name[ru]" class="form-control" id="name[ru]"
                                               ...
                                               value="{{ old('name[ru]',$item->name_ru) }}" required>
                                ...
                                <div class="form-group justify-content-end">
                                    <label class="col-md-12 mt-2"
                                           for="description[ru]">{{ __('validation.attributes.description') }}</label>
                                    <div class="col-md-12">
                                        <textarea rows="3" type="text" name="description[ru]" class="form-control"
                                                  id="description[ru]"
                                        >{{ old('description_ru',$item?->description_ru) }}</textarea>
                        ...
                        <div>
                            <div class="form-row col-md-12">
                                <div class="col-md-2 mb-3">
                                    ...
                                    <input name="quantity" value="{{ old('quantity',$item->quantity) }}" type="text"
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input name="date_entered" value="{{ old('date_entered',$item->date_entered) }}"
                                           type="date"
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input name="expiry_date" value="{{ old('expiry_date',$item->expiry_date) }}"
                                           type="date"
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="custom-select col-md-12" name="warehouse_category_id"
                                        ...
                                        @foreach($categories as $category)
                                            <option
                                                value="{{ $category->id }}" @selected($category->id == $item->warehouse_category_id)> {{$category->hname}} </option>
                                        @endforeach
                                    </select>
