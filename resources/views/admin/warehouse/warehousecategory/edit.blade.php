    ...
    <div class="d-flex justify-content-center mt-5">
        <div class="col-lg-10 col-xlg-9 col-md-7  ">
            <div class="card">
                ...
                <form class="form-horizontal " action="{{ route('warehouse.warehousecategory.update',[$item->id])}}"
                      method="post">
                    @csrf
                    @method('put')
                    ...
                    <div class="form-group text-center">
                        <a href="{{ route('warehouse.warehousecategory.index') }}"
