...
<div class="page-container">
    ...
    <div class="page-sidebar">
        ...
        <div class="sidebar-footer d-flex justify-content-around">
            <a class="pull-left" href="{{ route('profile.index') }}" data-toggle="tooltip" data-placement="top"
...
{{--                <i class="icon-lock"></i></a>--}}
            <a class="pull-left" href="{{ route('profile.logout') }}" data-toggle="tooltip" data-placement="top"
...
{{--         ht-100v--}}
         ">
            ...
            <div id="main-wrapper">
                ...
                <!-- Breadcrumb Start -->
                <!--================================-->
                {{--                @include('employee.layouts.page_breadcrumb')--}}
                {{--                <!--/ Breadcrumb End -->--}}
                @yield('content')
{{--                @dd(app()->getLocale())--}}
            </div>
...
<!--================================-->
{{--@include('admin.employee.layouts.color_switcher')--}}
<!--/ Color switcher  End  -->
<!--================================-->
<!-- Scroll To Top Start-->
<!--================================-->
